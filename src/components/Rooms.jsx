...
const Rooms = () => {
  return (
    <div className='max-w-[1400px] h-[500px] bg-blue-100 mx-auto my-20 pt-16 lg:mb-[20%] md:mb-[35%] px-4 grid lg:grid-cols-3 gap-4'>
      <div className='lg:top-20 rtl relative lg:col-span-1 col-span-2 rtl'>
        <h3 className='text-2xl font-bold'>  طراحی اختصاصی اقامتگاه ها </h3>
        <p className='pt-4 font-bold'>

        اتاق‌های داخلی ما با داشتن فضاهای فراوان، نورپردازی احساسی و امکانات مدرن شما را به خود جذب می‌کنند. در هر اقامتگاه، شما می‌توانید از یک محل آرام و دلنشین برخوردار شوید که احساس آرامش کنید
        </p>
      </div>
